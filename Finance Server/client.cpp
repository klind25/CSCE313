...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        finance_channel = new NetworkRequestChannel("127.0.0.1", finance_port, NetworkRequestChannel::Side::CLIENT_SIDE);
    ...
    try {
        ...
        logging_channel = new NetworkRequestChannel("127.0.0.1", logging_port, NetworkRequestChannel::Side::CLIENT_SIDE);
    ...
    try {
        ...
        file_channel = new NetworkRequestChannel("127.0.0.1", file_port, NetworkRequestChannel::Side::CLIENT_SIDE);
